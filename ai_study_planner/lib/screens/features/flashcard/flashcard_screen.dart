...
import '../../../components/service/flashcardService.dart';
  ...
  Future<void> _uploadAndGenerate() async {
    try {
      ...
      final newCard = Flashcard(
        ...
        title: topic.isNotEmpty ? 'Flashcards: $topic' : 'Flashcards from $filename',
        content: qa,
      );
                    ...
                    children: [
                      ...
                      if (flashcards.isEmpty) ...[
                        Container(
                          ...
                          child: Column(
                            children: [
                              Icon(Icons.style, color: Colors.pink[300], size: 36),
                        ...
                        Center(
                          child: TextButton(
                            onPressed: () {/* TODO: navigate to all flashcards */},
                            child: Text(
                              'See all flashcards',
                              style: TextStyle(
